...
var ke="@nilfoundation/niljs",De="=nil; Foundation",Se="0.14.0",Pe={type:"git",url:"git+https://gith\
...
ypto":"^1.1.0","@nilfoundation/smart-contracts":"^0.1.0","@noble/curves":"^1.4.0","@open-rpc/client-\
js":"^1.8.1","@rollup/plugin-json":"^6.1.0","@scure/bip39":"^1.3.0",abitype:"^1.0.2","tiny-invariant":"\
^1.3.3","ts-essentials":"^10.0.2",viem:"^2.16.3"},Je=["nil","blockchain","client"],Qe={name:ke,author:De,
version:Se,repository:Pe,homepage:He,bugs:Ee,engines:Ue,type:je,main:Re,module:Ke,files:We,types:Fe,
exports:Oe,sideEffects:Ve,description:_e,scripts:ze,license:Le,devDependencies:Ge,publishConfig:Xe,dependencies:Ye,
keywords:Je};const X=Qe.version;let N=class le extends Error{constructor(e,{isOperational:s=!0,cause:a,
docsPath:n}={}){super(),this.name=this.constructor.name,this.isOperational=s,this.cause=a,this.docsPath=
n,this.version=X,this.message=`${e??"An error occured"}
