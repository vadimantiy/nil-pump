...
freeze(e)}var x=be(pe),fe="@nilfoundation/niljs",we="=nil; Foundation",ve="0.14.0",Ie={type:"git",url:"\
...
16.0","@iden3/js-crypto":"^1.1.0","@nilfoundation/smart-contracts":"^0.1.0","@noble/curves":"^1.4.0",
"@open-rpc/client-js":"^1.8.1","@rollup/plugin-json":"^6.1.0","@scure/bip39":"^1.3.0",abitype:"^1.0.\
2","tiny-invariant":"^1.3.3","ts-essentials":"^10.0.2",viem:"^2.16.3"},Ue=["nil","blockchain","clien\
t"],Fe={name:fe,author:we,version:ve,repository:Ie,homepage:Te,bugs:xe,engines:Be,type:qe,main:$e,module:Ce,
files:Ae,types:Me,exports:He,sideEffects:Ee,description:De,scripts:Ne,license:ke,devDependencies:Pe,
