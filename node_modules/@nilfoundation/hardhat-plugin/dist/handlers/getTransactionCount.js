...
async function prepareInput(params, context) {
    const address = await context.signer.getAddress(context.hre.config.shardId ?? (0, conversion_1.shardNumber)(context.wallet.address)); // Simulate async call if necessary
